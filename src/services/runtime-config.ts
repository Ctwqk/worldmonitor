...
export const RUNTIME_FEATURES: RuntimeFeatureDefinition[] = [
  {
    ...
    fallback: 'Falls back to OpenRouter, then Local LLM via Watchdog, then local browser model.',
  },
  {
    id: 'aiOpenRouter',
    ...
    fallback: 'Falls back to Local LLM via Watchdog, then local browser model.',
  },
  {
    id: 'aiExo',
    name: 'Local LLM via Watchdog',
    description: 'Self-hosted local LLM routed through the watchdog queue and recovery layer.',
    requiredSecrets: [],
